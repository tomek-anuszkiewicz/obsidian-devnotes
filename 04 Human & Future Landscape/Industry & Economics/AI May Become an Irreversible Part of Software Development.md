...
- **[[AI Changes the Role and Training of Software Engineers]]**: How the irreversibility of AI shifts engineering skills from manual typing to design, verification, and risk management.
- **[[The First AI-Native Generation of Software Engineers]]**: The emergence of developers who have never programmed without agentic scaffolding.
- **[[Agentic Coding Harness and Controlled Development Workflows]]**: Maintaining strict human control and determinism over irreversible agent integration.
- **[[Software Engineering May Shift Toward Code Optimized for Agents]]**: How codebases permanently restructure themselves for machine comprehension.
- **[[What Should Organizations Preserve from AI-Assisted Development]]**: Safeguarding institutional knowledge and critical capabilities in an AI-dominated lifecycle.
