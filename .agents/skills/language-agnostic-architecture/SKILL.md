---
name: language-agnostic-architecture
description: Guidelines for expressing architectural principles using universal software engineering abstractions, pseudocode, and multi-ecosystem breadth instead of single-language code dumps.
---

# Language-Agnostic Architecture & Generalized Technology Abstractions Skill
