---
name: vault-linking
description: Dual-layer graph connectivity, hub-and-spoke topology, inline piped wikilinks, and knowledge graph integrity rules.
---

# Vault Linking & Knowledge Graph Integrity Skill
