---
name: vault-linking
description: Add and maintain useful Obsidian links without turning every note into a graph template.
---

# Vault Linking

Link when a target gives the reader useful prerequisite context, a concrete continuation, or a meaningful contrast. Prefer the closest domain hub when it genuinely helps navigation. Use a natural link label when it reads better in a sentence.
