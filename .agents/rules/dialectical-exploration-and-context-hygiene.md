...
- **Dialogue-Driven Convergence**: Explore and refine the domain together until the user decides the mental model is mature. Only upon explicit confirmation does the agent transition to drafting notes per [`information-hierarchy`](file:///d:/GoogleDrive/AI/Obsidian/Default/.agents/skills/information-hierarchy/SKILL.md) and [`practitioner-voice`](file:///d:/GoogleDrive/AI/Obsidian/Default/.agents/skills/practitioner-voice/SKILL.md).
