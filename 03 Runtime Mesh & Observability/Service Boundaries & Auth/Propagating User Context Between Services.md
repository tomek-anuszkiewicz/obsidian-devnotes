...
5. **Decoupling Technical Traces from User Identity**: Distributed tracing ([OpenTelemetry](file:///d:/GoogleDrive/AI/Obsidian/Default/03%20Runtime%20Mesh%20&%20Observability/Semantic%20Telemetry/OpenTelemetry.md)) tracks physical execution hops. It must not be conflated with business correlation IDs or user identity.
