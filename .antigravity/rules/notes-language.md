...
5. **Vault Cohesion & Reinforcing Established Thinking**:
   ...
   - When creating, updating, or reviewing notes, actively search and inspect existing notes in the workspace (across `01 Architecture & Systems/`, `02 Engineering Practice/`, `03 LLM Theory & Cognition/`, and `04 Human & Future Landscape/`).
