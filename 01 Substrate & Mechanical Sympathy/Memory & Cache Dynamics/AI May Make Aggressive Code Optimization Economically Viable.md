...
## The Hardware Reality: Modern Mechanical Sympathy vs. Legacy Hacks
...
Genuine mechanical sympathy requires balancing branch prediction efficiency against L1i instruction density:
...
Mechanical sympathy applies equally to data structures. Traditional Object-Oriented layouts scatter data across the heap via references:
```text
...
- **[[Data Access Economics with Coding Agents - ORMs vs Explicit SQL]]**: Applying mechanical sympathy and direct execution plans to relational database engines.
- **[[The 5-Layer System Stack for Agentic Software Engineering]]**: Anchoring mechanical sympathy and cache dynamics in Layer 1 (Substrate).
