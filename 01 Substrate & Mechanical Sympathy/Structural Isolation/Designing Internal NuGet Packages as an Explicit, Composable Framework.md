...
- **[[Internal NuGet Packages vs Agent-Generated Code]]**: The strategic boundary between shared binary packages and localized agent-generated code.
...
- **[[Hidden Abstractions May Become More Expensive in Agent-Maintained Code]]**: Why magic frameworks and implicit DI containers impede agent reasoning.
- **[[Designing Software for AI Agents]]**: Architectural guidelines favoring explicit composition over ambient framework magic.
- **[[AI Changes the Economics of Software Libraries]]**: How cheap code generation shifts the build-versus-buy trade-off for internal shared libraries.
