...
Without operational budgets, agents can drift into optimization theater: complicated code that adds risk for negligible gain. A performance gate should require the existing behavior to remain correct, show a meaningful improvement under representative load, and reject complexity that the measured gain does not justify.
