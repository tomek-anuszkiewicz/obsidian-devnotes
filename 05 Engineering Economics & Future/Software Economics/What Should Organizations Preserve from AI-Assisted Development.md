...
- **Human Code Review Dissents**: The exact rationale a senior engineer provides when rejecting syntactically valid code—such as unindexed queries that choke at production scale, subtle violations of domain invariants, or abstractions that perform poorly under production load.
