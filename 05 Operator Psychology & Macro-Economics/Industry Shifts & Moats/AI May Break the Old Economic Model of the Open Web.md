...
- **[[WebMCP - Turning Web Applications into Agent-Native Toolkits]]**: The browser protocol shift where web pages become semantic toolkits, bypassing ad impressions.
- **[[How AI Agents May Control Computers, Applications, and the Web]]**: How autonomous agent navigation disrupts click-through monetization.
- **[[Finding Original Knowledge in an Internet Full of Repetition]]**: The degradation of public web content and the rising premium on verified, original data.
- **[[Fresh Contact With Reality May Become the Training Bottleneck]]**: Why training on synthetic, SEO-optimized web slop triggers model degradation.
- **[[Unbundling of Enterprise Software]]**: How agents disintermediate traditional web portals and software distribution funnels.
